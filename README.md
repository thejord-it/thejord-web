...
[![GitHub Stars](https://img.shields.io/github/stars/thejord-it/thejord-web?style=flat-square&logo=github&color=yellow)](https://github.com/thejord-it/thejord-web/stargazers)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg?style=flat-square)](https://opensource.org/licenses/MIT)
[![Next.js](https://img.shields.io/badge/Next.js-16.0.7-000000?logo=next.js&logoColor=white&style=flat-square)](https://nextjs.org/)
...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](https://github.com/thejord-it/thejord-web/pulls)

<p align="center">
  <a href="https://thejord.it"><strong>🌐 Live Demo</strong></a> •
  <a href="https://thejord.it/blog"><strong>📖 Blog</strong></a> •
  <a href="https://github.com/thejord-it/thejord-web/issues"><strong>🐛 Report Bug</strong></a> •
  <a href="https://github.com/thejord-it/thejord-web/issues"><strong>✨ Request Feature</strong></a>
</p>

**Modern, fast, and free tools for developers.**
**A comprehensive suite of online utilities built with Next.js, React 19, and Tailwind CSS.**
...
📄 **PDF Tools Suite** - Merge, Split, Compress, Convert, and Edit PDFs entirely in browser
🗜️ **Real PDF Compression** - Ghostscript WASM for actual file size reduction
🌐 **i18n Support** - Full English and Italian localization
🧪 **132 Tests** - Comprehensive test coverage with Jest + Playwright
📝 **Tech Blog** - Developer articles and tool guides

---

### 🚀 **Quick Links**

| 📄 [JSON Formatter](https://thejord.it/en/tools/json-formatter) | 🔐 [Base64 Tool](https://thejord.it/en/tools/base64) | 🔍 [RegEx Tester](https://thejord.it/en/tools/regex-tester) |
|:--:|:--:|:--:|
| **[Hash Generator](https://thejord.it/en/tools/hash-generator)** | **[URL Tool](https://thejord.it/en/tools/url-encoder)** | **[Color Picker](https://thejord.it/en/tools/color-converter)** |
| **[🕐 Cron Builder](https://thejord.it/en/tools/cron-builder)** | **[📋 JSON Schema](https://thejord.it/en/tools/json-schema)** | **[📝 Markdown](https://thejord.it/en/tools/markdown-converter)** |
| **[📄 PDF Tools](https://thejord.it/en/tools/pdf-tools)** | **[📰 Lorem Ipsum](https://thejord.it/en/tools/lorem-ipsum)** | **[📊 Diff Checker](https://thejord.it/en/tools/diff-checker)** |
...
<table>
  <tr>
    <td align="center">🔒</td>
    <td><b>Privacy-First</b><br/>All tool processing happens in your browser. Zero data sent to servers.</td>
  </tr>
  <tr>
    <td align="center">⚡</td>
    <td><b>Lightning Fast</b><br/>Built with Next.js 16 Turbopack, React 19, and optimized for performance.</td>
  </tr>
  <tr>
    <td align="center">📄</td>
    <td><b>PDF Tools Suite</b><br/>Merge, split, compress (real Ghostscript), convert, and edit PDFs entirely client-side.</td>
  </tr>
  <tr>
    <td align="center">🌍</td>
    <td><b>Works Offline</b><br/>Tools work offline after first load. PWA-ready.</td>
  </tr>
  <tr>
    <td align="center">🌐</td>
    <td><b>Multilingual</b><br/>Full English and Italian support with next-intl.</td>
  </tr>
  <tr>
    <td align="center">📝</td>
    <td><b>Tech Blog</b><br/>Integrated blog with SSR, SEO optimization, and CMS.</td>
  </tr>
</table>
...
### 🌐 Online (Recommended)
Visit [**thejord.it**](https://thejord.it) - No installation needed!
...
[![Star History Chart](https://api.star-history.com/svg?repos=thejord-it/thejord-web&type=Date)](https://star-history.com/#thejord-it/thejord-web&Date)
...
- **Issues**: [GitHub Issues](https://github.com/thejord-it/thejord-web/issues)
