  ...
  return (
    <div className="min-h-screen bg-bg-darkest">
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-bg-dark border border-border rounded-xl p-6">
              <h2 className="text-2xl font-bold mb-6 text-text-primary">Contact Methods</h2>
          ...
          {/* Contact Form */}
          <div className="bg-bg-dark border border-border rounded-xl p-6">
            <h2 className="text-2xl font-bold mb-6 text-text-primary">Send a Message</h2>
        ...
        {/* FAQ Section */}
        <section className="bg-bg-dark border border-border rounded-xl p-8">
