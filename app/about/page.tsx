    ...
    <div className="min-h-screen bg-bg-darkest">
      <main className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="bg-bg-dark border border-border rounded-xl p-4 md:p-8 mb-4 md:mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-text-primary">Our Mission</h2>
        ...
        {/* Tech Stack Section */}
        <section className="bg-bg-dark border border-border rounded-xl p-4 md:p-8 mb-4 md:mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-text-primary">Tech Stack</h2>
        ...
        {/* Open Source Section */}
        <section className="bg-bg-dark border border-border rounded-xl p-4 md:p-8 mb-4 md:mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-text-primary">Open Source</h2>
        ...
        <section className="bg-bg-dark border border-border rounded-xl p-4 md:p-8 mb-4 md:mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-text-primary">Privacy & Security</h2>
          <p className="text-text-secondary mb-4">
        ...
        <section className="bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/30 rounded-xl p-4 md:p-8 text-center">
          <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-text-primary">Questions or Feedback?</h2>
          <p className="text-text-secondary mb-4 md:mb-6">
